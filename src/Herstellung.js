...
const HerstellungDefault = () => (
    <div className="intro">
        <div className="intro-desc">
            <p>Knopf um Knopf stellen wir alles selber her. Vom Zuschneiden der F&auml;den in der richtigen L&auml;nge
                bis zum abschliessenden Z&ouml;pfeln ist jeder Artikel von uns selbst gekn&uuml;pft.</p>
        </div>
        <div className="intro-desc">
            <p>Haben Sie auch schon gekn&uuml;pft und eine Frage dazu oder kommen Sie bei einem Muster nicht weiter? Wir
                helfen Ihnen gerne. Kommen Sie doch mit Ihrer Arbeit am n&auml;chsten Markttage vorbei.</p>
        </div>
    </div>
);
        ...
        <div className="intro">
            <div className="intro-desc">
                ...
                <p>Um sp&auml;ter ein Muster nachkn&uuml;pfen zu k&ouml;nnen, ist es hilfreich, einen Plan zu zeichnen,
                    ...
                    wie friendship-bracelet.net, ihn zur Verf&uuml;gung
                    stellt.
                </p>
            </div>
            <div className="intro-desc">
        ...
        <div className="intro">
            <div className="intro-desc">
                ...
                <p>Zuerst schneide ich die 38 F&auml;den zu. Da ich das Muster zum ersten Mal kn&uuml;pfe, w&auml;hle
                    ...
                    den Tisch. In diesem Fall habe ich zuerst die
                    22 crèmefarbenen F&auml;den aufgeklebt und anschliessend die andersfarbigen F&auml;den am richtigen
                    Ort hinzugef&uuml;gt.</p>
            </div>
            <div className="intro-desc">
                <img src="http://api0.geknuepft.ch/v0/Image/800p/content/herstellung1.jpg" alt="ready"/>
            </div>
        </div>
        <div className="intro">
            <div className="intro-desc">
                ...
                <p>Die erste Reihe gerade hinzubekommen ist mitunter am Schwierigsten. Auch ich gerate etwas schief,
                    ...
                    Reihen, sodass alle F&auml;den gut ineinander verknotet
                    sind und sich keiner mehr herausziehen l&auml;sst.</p>
                <br/>
            ...
            <div className="intro-desc">
                <img src="http://api0.geknuepft.ch/v0/Image/800p/content/herstellung2.jpg" alt="Marktstand"/>
            </div>
        </div>
        <div className="intro">
            <div className="intro-desc">
                <h2>Kn&uuml;pfen</h2>
                <p>W&auml;hrend dem Kn&uuml;pfen chte ich darauf, m&ouml;glichst gleichm&auml;ssig die Knoten
                    anzuziehen. Das ist nicht immer einfach. Gerade die Wendekn&ouml;pfe gerate meist etwas gr&ouml;
                    sser. Passiert mit einen Fehler, hilft eine stumpfe Nadel.
                    Ich habe diese an einem rotschwarzen, gewickelten B&auml;ndeli angebunden, damit ich sie nicht
                    verliere.</p>
                <br/>
            ...
            <div className="intro-desc">
                <img src="http://api0.geknuepft.ch/v0/Image/800p/content/herstellung3.jpg" alt="Marktstand"/>
            </div>
        </div>
        <div className="intro">
            <div className="intro-desc">
                ...
                <p>Bin ich mit der L&auml;nge zufrieden, klebe ich das Armband so auf den Tisch, dass die losen F&auml;
                    ...
                    stelle also 3 Z&ouml;pfe her. Bei d&uuml;nnen
                    Armb&auml;ndern ist ein Zopf ausreichend, bei mitteldicken zwei Z&ouml;pfe. Um den Zopf
                    abzuschliessen, ziehe ich einen festen Knoten.</p>
                <br/>
            ...
            <div className="intro-desc">
                <img src="http://api0.geknuepft.ch/v0/Image/800p/content/herstellung4.jpg" alt="Marktstand"/>
            </div>
        </div>
        <div className="intro">
            <div className="intro-desc">
            ...
            <div className="intro-desc">
                <img src="http://api0.geknuepft.ch/v0/Image/800p/content/herstellung5.jpg" alt="Marktstand"/>
            </div>
        </div>
    </div>
);
