...
const HerstellungDefault = () => (
    <div className="intro">
        <div className="intro-desc">
            <p>Knopf um Knopf stellen wir alles selber her. Vom Zuschneiden der F&auml;den in der richtigen L&auml;nge bis zum abschliessenden Z&ouml;pfeln ist jeder Artikel von uns selbst gekn&uuml;pft.</p>
        </div>
        <div className="intro-desc">
            <p>Haben Sie auch schon gekn&uuml;pft und eine Frage dazu oder kommen Sie bei einem Muster nicht weiter? Wir helfen Ihnen gerne. Kommen Sie doch mit Ihrer Arbeit am n&auml;chsten Markttage vorbei.</p>
        </div>
    </div>
);
    ...
    <div>
        ...
        <div className="intro">
            <div className="intro-desc">
                ...
                <p>Das eine ist vom andern nicht wegzudenken. Manchmal w&auml;hle ich zuerst das Muster und suche passende Farben. Manchmal m&ouml;chte ich unbedingt mit gewissen Farben etwas kn&uuml;pfn und suche mir ein entsprechendes Muster.</p>
                <br/>
                <p>Um sp&auml;ter ein Muster nachkn&uuml;pfen zu k&ouml;nnen, ist es hilfreich, einen Plan zu zeichnen, auf dem alle F&auml;den und Kn&ouml;pfe ersichtlich sind. Hilfreich hierbei sind auch Generatoren, wie friendship-bracelet.net, ihn zur Verf&uuml;gung stellt.
                </p>
            </div>
            <div className="intro-desc">
        ...
        <div className="intro">
            <div className="intro-desc">
                <h2>Vorbereitung</h2>
                <p>Ich habe mich f&uuml;r ein Muster von friendship-bracelets.net entschieden, denn es ist mit 38 F&auml;den eher breit und erm&ouml;glicht in drei Farbnuancen zu kn&uuml;pfen. Als Hintergrundfarben dienen mir crème und braun.</p>
                <br/>
        ...
        <div className="intro">
            <div className="intro-desc">
                <h2>Anfang</h2>
                <p>Die erste Reihe gerade hinzubekommen ist mitunter am Schwierigsten. Auch ich gerate etwas schief, weiss aber, dass ich dies sp&auml;ter noch ausgleichen kann. So kn&uuml;pfe ich die ersten 5-10 Reihen, sodass alle F&auml;den gut ineinander verknotet sind und sich keiner mehr herausziehen l&auml;sst.</p>
                <br/>
        ...
        <div className="intro">
            <div className="intro-desc">
                <h2>Kn&uuml;pfen</h2>
                <p>W&auml;hrend dem Kn&uuml;pfen achte ich darauf, m&ouml;glichst gleichm&auml;ssig die Knoten anzuziehen. Das ist nicht immer einfach. Gerade die Wendekn&ouml;pfe geraten meist etwas gr&ouml;sser. Passiert mir einen Fehler, hilft eine stumpfe Nadel.</p>
                <br/>
        ...
        <div className="intro">
            <div className="intro-desc">
                <h2>Abschluss</h2>
                <p>Bin ich mit der L&auml;nge zufrieden, klebe ich das Armband so auf den Tisch, dass die losen F&auml; den zu mir zeigen. In diesem Fall, bei 38 F&auml;den, teile ich die losen F&auml;den durch 3 und stelle also 3 Z&ouml;pfe her. Bei d&uuml;nnen Armb&auml;ndern ist ein Zopf ausreichend, bei mitteldicken zwei Z&ouml;pfe. Um den Zopf abzuschliessen, ziehe ich einen festen Knoten.</p>
                <br/>
