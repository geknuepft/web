...
const Warenkorb = () => (
    ...
    >
        <div className="head"
             style="background-image:url(http://api0.geknuepft.ch/v0/Image/800p/content/marktstand.jpg);">
            <span>Warenkorb</span>
        </div>
        <div>
            <div className="intro">
            ...
            <table className="cart">
                ...
                <tr>
                    <td className="center img"><img
                        src="http://api0.geknuepft.ch/v0/Image/150p/cma0/160523_1/IMG_3079.JPG"/></td>
                    <td className="left">
                        <h4>Armband</h4>
                        <p>Länge:
                ...
                <tr>
                    <td className="center img"><img
                        src="http://api0.geknuepft.ch/v0/Image/150p/cma0/160523_1/IMG_3232.JPG"/></td>
                    <td className="left">
                        <h4>Armband</h4>
                        <p>Länge: 15cm</p>
                        <p>Abschluss: Zopf</p>
